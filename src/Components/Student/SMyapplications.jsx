...
import {SActivedrives} from "./SActivedrives";
                 ...
                 <h1 className="mt-3 mx-10">Below you will find job roles you have applied for</h1>
                    {
                      drives.map((drive) => (
                        ...
                        ((info || []).some(studentInfo => studentInfo.company.includes(drive.companyName))) &&   <div key={drive.id} className="relative w-full mx-10 mr-7 mt-10 h-48 flex bg-clip-border rounded-xl bg-white text-gray-700 shadow-md flex-row">
