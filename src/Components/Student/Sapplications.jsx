...
export function Sapplications(props) {
    ...
    return (
        <>
            <div class="relative w-full mx-10  mt-10 h-48 flex bg-clip-border rounded-xl bg-white text-gray-700 shadow-md flex-row">
                <div
                ...
                <div class="p-4">
                    ...
                    <a href="#" class="inline-block"><button
                        ...
                        type="button">
                        Applied<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
