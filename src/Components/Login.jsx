...
import { SEditprofile } from './Student/SEditprofile'
...
export function Login() {
  ...
  const onSuubmit = (e) => {
    ...
    handleUpdateState({ "name": "Satvik1", "email": email });
    e.preventDefault();
    axios.post('http://localhost:8000/student/login', { email, password, role })
      .then(res => {
        if (res.data !== "Password is incorrect" && res.data !== "User not found") {
          console.log("Success");
          if (role === "2")
            navigate('/student/editprofile', { state: { email: email } });
          else
            navigate(`/company/dashboard/${email}`, { state: { userData: res.data } });
        }
        else {
        ...
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          <form onSubmit={onSuubmit} >
            <div className="space-y-5">
              ...
              {data &&
                <p style={{ color: "black", marginTop: "10px", marginBottom: "10px" }}><strong>{data}</strong></p>
              }
              <div>
                  ...
                  <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div className="flex items-center ps-3">
                      <input id="horizontal-list-radio-license" type="radio" value="" name="list-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                        onChange={() => setRole("0")} />
                      <label for="horizontal-list-radio-license" className="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Admin</label>
                    </div>
                  </li>
                  <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div className="flex items-center ps-3">
                      <input id="horizontal-list-radio-id" type="radio" value="" name="list-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                        onChange={() => setRole("1")} />
                      <label for="horizontal-list-radio-id" className="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Recruiter</label>
                    </div>
                  </li>
                  <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                    <div className="flex items-center ps-3">
                      <input id="horizontal-list-radio-military" type="radio" value="" name="list-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                        onChange={() => setRole("2")} />
                      <label for="horizontal-list-radio-military" className="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Student</label>
                    </div>
                  </li>
                </ul>
              </div>
