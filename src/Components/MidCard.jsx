...
export function MidCard() {
  return (
    <section className='flex justify-center mt-11'>
      <div className="px-4 py-8 align-middle " >
        <h2 className="text-2xl font-bold tracking-tight flex justify-center text-customBlue xl:text-4xl">
          Welcome To Campus CareerHub
        </h2>
        <p className="mt-8  block max-w-4xl text-gray-500">
        ...
        <div className="mt-9 flex justify-center">
          ...
          <a
            href="/login"
            className="mt-4 inline-flex w-full items-center justify-center overflow-hidden rounded-lg bg-customBlue px-4 py-2.5 text-sm text-white shadow transition-colors duration-300 hover:bg-customBlue focus:ring focus:ring-blue-300 focus:ring-opacity-80 sm:mx-2 sm:mt-0 sm:w-auto"
          >
            <svg
              className="mx-2 h-5 w-5 fill-current"
